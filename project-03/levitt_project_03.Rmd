...
weather_tpa %>%
  ...
  geom_area(stat = "density", kernel = "gaussian", bw = 0.5, fill = "darkgray", color = "black") +
...
plot_ly(
  ...
  type = "scatter",
  mode = "markers",
  marker = list(color = "lightblue", size = 6),
  text = ~paste("Date:", date, "<br>Precip:", precipitation, "in"),
  hoverinfo = "text"
) %>%
  layout(
    title = "Daily Precipitation in TPA Florida",
